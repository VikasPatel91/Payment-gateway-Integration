...
export default function SignUp() {
    ...
    return <>
        ...
        <form className="adjust-signup" action="/headlines" onSubmit={HandleForm}>
            <div className="text-center mt-4 signup-heading">Get Start With Free Account</div>
            <div className="signup-left-side">
                <label className="signup-name-label signup-parent">Enter Your Name</label>
                <input type="text" placeholder="Your Name" id="signup-name" name="name" onChange={HandleChange} />

                <label className="signup-phone-lebel signup-parent">Enter Phone Number</label>
                <input type="number" id="signup-phone" placeholder="Your Phone" name="phone" onChange={HandleChange} />
            </div>

            <div className="signup-right-side">
                <label className="signup-email-lebel signup-parent">Enter Email Id</label>
                <input type="text" id="signup-email" placeholder="Email Id" name="email" onChange={HandleChange} />

                <label className="signup-password-lebel signup-parent">Enter Password</label>
